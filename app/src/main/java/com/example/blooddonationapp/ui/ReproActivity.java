...
import com.example.blooddonationapp.databinding.ActivityReproBinding;
...
public class ReproActivity extends AppCompatActivity {
    ...
    private static final String TAG = "ReproActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.backlog1.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.inputDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                picker = new DatePickerDialog(ReproActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        binding.registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    binding.inputPassword.setError("Type your date of birth (dd/mm/yyyy)");
    ...
    private void registerUser(String name,String email,String phone,String category,String password,String gender,String DoB,String address,boolean access_granted,long access_until,boolean dataLocked,String image)
    {
        ...
        auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(ReproActivity.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful())
                {
                    Toast.makeText(ReproActivity.this, "Recipient Registration Successful", Toast.LENGTH_SHORT).show();
                    ...
                    referenceProfile2.child(firebaseUser.getUid()).setValue(writeUserDetails).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful())
                            {
                                firebaseUser.sendEmailVerification();
                                Toast.makeText(ReproActivity.this, "Recipient Registration Successful.Please verify your Email", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(ReproActivity.this,MainActivity.class);
                            ...
                            {
                                Toast.makeText(ReproActivity.this, "Recipient Registration Failed.Please verify your Email", Toast.LENGTH_SHORT).show();
                            }
                            progressBar1.setVisibility(View.GONE);
                        }
                    });
                ...
                else
                {
                    ...
                    catch(Exception e)
                    {
                        ...
                        Toast.makeText(ReproActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
